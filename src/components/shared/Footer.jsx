...
const Footer = () => {
  ...
  const content = {
    zh: {
      description: '野所 ROTOHAUS 致力于通过艺术驻地、工作坊与跨文化对话，连接传统工艺与当代创作。',
      contact: '联系我们',
      social: '关注我们',
    },
    en: {
      description: 'ROTOHAUS bridges traditional craftsmanship and contemporary creation through artist residencies, workshops, and cross-cultural dialogue.',
      contact: 'Contact',
      social: 'Follow Us',
    }
  };
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-12 lg:gap-20">
          ...
          <FadeIn className="lg:max-w-md">
            <motion.img
              ...
              src="/rotohaus-logo.png"
              alt="Rotohaus"
              className="w-16 h-16 mb-5 rounded-lg object-cover"
            />
            <p
              className="text-white/50 text-sm leading-relaxed"
              style={{ fontFamily: isEnglish ? "'Helvetica Neue', sans-serif" : "'Huiwen-Fangsong', serif" }}
            >
              {t.description}
            </p>
          </FadeIn>
            ...
            <FadeIn delay={0.1}>
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                <li className="flex items-center gap-3">
                  ...
                  <motion.a
                    href="mailto:info@rotohaus.com"
                    className="hover:text-[#E2D19E] transition-colors duration-300"
                    whileHover={{ x: 2 }}
                  >
                    info@rotohaus.com
                  </motion.a>
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                ...
                {!isEnglish && (
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-white/70">ROTOHAUS野所</span>
                  </li>
                )}
              </ul>
            </FadeIn>
