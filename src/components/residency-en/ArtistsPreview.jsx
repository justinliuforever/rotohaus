...
const flyingArtists = [
  { name: 'Cevian Chen', image: '/images/residency/artists/cevian-chen/portrait.png', accentColor: '#7E79D6' },
  { name: 'Luca He', image: '/images/residency/artists/luca-he/portrait.png', accentColor: '#6B8EC2' },
];
        ...
        <FadeInSection delay={0.15} className="mb-12 lg:mb-16">
          <div className="flex items-center gap-4 justify-center mb-8">
            ...
            <span
              ...
              style={{ fontFamily: "'Helvetica Neue', sans-serif", color: '#7E79D6', fontWeight: 300 }}
            >
              Flying Artists
            </span>
