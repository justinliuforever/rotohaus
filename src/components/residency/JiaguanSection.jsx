...
const StackedPhoto = ({ src, alt, className, rotate = 0, delay = 0, zIndex = 1 }) => {
  return (
    <motion.div
      ...
      className={`absolute bg-[#E8EBEC] p-2 lg:p-3 shadow-xl cursor-pointer ${className}`}
      style={{ zIndex }}
    >
      <img
        src={src}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="relative h-[500px] lg:h-[700px] mb-20 lg:mb-32">
          <StackedPhoto
            src="/images/residency/jiaguan/jiaguan-4.png"
            alt="夹关镇街景"
            className="w-40 h-32 lg:w-72 lg:h-56 left-[5%] top-[5%]"
            rotate={-6}
            delay={0}
            zIndex={3}
          />
          ...
          <StackedPhoto
            ...
            alt="夹关镇建筑"
            className="w-48 h-40 lg:w-80 lg:h-64 right-[10%] top-[0%]"
            rotate={4}
            delay={0.1}
            zIndex={5}
          />
          ...
          <StackedPhoto
            ...
            alt="夹关镇风光"
            className="w-36 h-36 lg:w-60 lg:h-60 left-[15%] top-[30%]"
            rotate={-3}
            delay={0.15}
            zIndex={4}
          />
          ...
          <StackedPhoto
            ...
            alt="夹关镇文化"
            className="w-44 h-44 lg:w-72 lg:h-72 left-[35%] top-[20%]"
            rotate={2}
            delay={0.2}
            zIndex={6}
          />
          ...
          <StackedPhoto
            ...
            alt="夹关镇生活"
            className="w-40 h-44 lg:w-64 lg:h-72 right-[5%] top-[35%]"
            rotate={-4}
            delay={0.25}
            zIndex={2}
          />
          ...
          <StackedPhoto
            ...
            alt="夹关镇古迹"
            className="w-52 h-32 lg:w-80 lg:h-48 left-[0%] bottom-[5%]"
            rotate={3}
            delay={0.3}
            zIndex={7}
          />
          ...
          <StackedPhoto
            ...
            alt="夹关镇美食"
            className="w-56 h-36 lg:w-96 lg:h-56 right-[15%] bottom-[0%]"
            rotate={-2}
            delay={0.35}
            zIndex={8}
          />
