...
const TeamMemberCard = ({ name, nameEn, role, roleEn, description, image, delay = 0, align = 'left' }) => {
  ...
  return (
    ...
    >
      <div className={`flex flex-col ${isRight ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-8 lg:gap-12 items-start`}>
        {/* Avatar and Name */}
        <motion.div
        ...
        >
          <img
            src={image}
            alt={name}
            className="w-48 lg:w-56 h-48 lg:h-56 rounded-full object-cover mx-auto lg:mx-0"
